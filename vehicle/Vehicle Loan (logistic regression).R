...
library(ROSE)
library(nnet)
setwd('C:/Users/user/Desktop/School/Year 4/Sem 2/RE6013 Business Analytics/Project')
...
#logistic regression to predict loan amount ---------------------------------------------------------------------
VehicleLoan_undefaulted.dt <- VehicleLoan.dt[loan_default == 0]
summary(VehicleLoan_undefaulted.dt)
#set tiers for loan amounts (tier1: >60,000 tier2:50,000-60,000 tier3:40,000-50,000 tier4:10,000-40,000 )
for(i in 1:182543){
if (VehicleLoan_undefaulted.dt$disbursed_amount[i] > 60000) {
  VehicleLoan_undefaulted.dt$loantier[i] = 'tier 1'
} else if (VehicleLoan_undefaulted.dt$disbursed_amount[i] <= 60000 & VehicleLoan_undefaulted.dt$disbursed_amount[i] > 50000) {
  VehicleLoan_undefaulted.dt$loantier[i] = 'tier 2'
} else if (VehicleLoan_undefaulted.dt$disbursed_amount[i] <= 50000 & VehicleLoan_undefaulted.dt$disbursed_amount[i] > 40000) {
  VehicleLoan_undefaulted.dt$loantier[i] = 'tier 3'
} else {
  VehicleLoan_undefaulted.dt$loantier[i] = 'tier 4'
}
}
VehicleLoan_undefaulted.dt[, "disbursed_amount" := NULL]

VehicleLoan_undefaulted.dt$loantier <- factor(VehicleLoan_undefaulted.dt$loantier)

VehicleLoan_undefaulted.dt$loantier2 <- relevel(VehicleLoan_undefaulted.dt$loantier, ref = "tier 1")
test <- multinom(loantier2 ~. , data = VehicleLoan_undefaulted.dt, maxit = 1000)
...
summary(test)
library(ggplot2)
ggplot(VehicleLoan_undefaulted.dt, aes(x=disbursed_amount,y)) + geom_point(stat = "identity")
